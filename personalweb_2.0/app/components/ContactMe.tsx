...
export default function ContactMe({}: Props) {
  return (
    ...
    {/* <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly items-center'> */}
        ...
        <div className='flex flex-col space-y-7 max-md:mb-16 max-xl:space-y-5 px-32 max-md:space-y-9' >
            ...
            <div className='space-y-5 max-xl:space-y-2 max-md:mb-16'>
                <div className='flex items-center space-x-5 justify-center max-md:space-x-2'>
                <a href="https://api.whatsapp.com/send/?phone=34604124841&text=Hola+Luciano%2C+he+visto+tu+curriculum+vitae+y+quer%C3%ADa+ponerme+en+contacto+contigo+por+una+oferta+de+trabajo.&type=phone_number&app_absent=0" target="_blank" className='flex space-x-5'>
                    <PhoneIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse max-md:h-5 max-md:w-5'/>
                    <p className='text-2xl max-xl:text-base'>+ 34 604 12 48 41</p>
                    </a>
                </div>
                ...
                <div className='flex items-center space-x-5 justify-center max-md:space-x-2'>
                    ...
                    <EnvelopeIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse max-md:h-5 max-md:w-5'/>
                    <p className='text-2xl max-xl:text-base'>llemos@uoc.edu</p>
                    </a>
                </div>

                <div className='flex items-center space-x-5 justify-center max-md:space-x-2'>
                    <MapPinIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse max-md:h-5 max-md:w-5'/>
                    <p className='text-2xl max-xl:text-base'>Las Palmas de Gran Canaria</p>
                </div>
            </div>
            ...
            <div >
                ...
                {/* className='flex flex-col space-y-2 w-fit mx-auto'> */}
                    ...
                    <button
                        type="submit"
                        className='bg-[#F7AB0A] py-5 px-10 rounded-md text-black font-bold max-md:py-3 max-md:px-5'>Enviar
                    </button>
