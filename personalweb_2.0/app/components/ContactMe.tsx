...
export default function ContactMe({}: Props) {
  return (
    ...
    {/* <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly items-center'> */}
        <h3 className='absolute top-24 uppercase tracking-[20px] max-md:tracking-[10px] text-gray-500 text-2xl'>
            Contacto
        </h3>

        {/* Datos personales */}
        <div className='flex flex-col space-y-10 px-32 max-md:space-y-5 max-xl:space-y-7'>
            <h4 className='grid text-4xl max-xl:text-2xl font-semibold text-center max-md:text-base'>
                Tengo justo lo que usted necesita.
                <span className='decoration-[#F7AB0A]/50 underline'>Contácteme</span>
            </h4>
            <div className='space-y-6 max-xl:space-y-4 max-md:space-y-2'>
